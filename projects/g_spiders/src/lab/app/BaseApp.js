...
// ===========================================
	...
	*/
	LAB.app.BaseApp.prototype.registerMouseEvents = function(){
      ...
      window.addEventListener("keydown", LAB.self._onDocumentKeyDown);
      
      window.addEventListener("resize", LAB.self._onWindowResized);
	}
	/**
	...
	*/
	LAB.app.BaseApp.prototype.unregisterMouseEvents = function()
	{
      ...
      window.removeEventListener("keydown", LAB.self._onDocumentKeyDown);
      
      window.removeEventListener("resize", LAB.self._onWindowResized);
	}
