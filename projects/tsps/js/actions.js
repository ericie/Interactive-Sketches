...
function draw() {
	...
	*/
	...
	for (var id in tsps.people){
		...
		var randContour = Math.round(Math.random()*person.contours.length);
		randContour = person.contours[randContour]
		...
		circle(window.innerWidth * randContour.x, window.innerHeight * randContour.y, s);

		//console.log(randContour);
