...
LAB.three.Camera.prototype.makeOrtho = function( _nearClip, _farClip, _w, _h ){
   var w = _w/2 || window.innerWidth/2;
   var h = _h/2 || window.innerHeight/2;
   this.projectionMatrix = THREE.Matrix4.makeOrtho(-w, w, h, -h,
                                                   _nearClip || -1000,
                                                   _farClip || 1000 );
};
